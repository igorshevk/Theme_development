(function($) {
	...
	// ______________Full screen
		...
		$("#fullscreen-button").on("click", function(e) {
		  ...
		  screenfull.isFullscreen ? (p(".nav-link-expand").find("i").toggleClass("bx-exit-fullscreen fa-fullscreen"), $("body").addClass("full-screen")) : ($(".nav-link-expand").find("i").toggleClass("fa-fullscreen bx-exit-fullscreen"), $("html").removeClass("full-screen"))
		 }),
