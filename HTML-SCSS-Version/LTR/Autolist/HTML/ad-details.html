								...
								<div class="search-background bg-transparent">
									<div class="form row no-gutters ">
										<div class="form-group  col-xl-4 col-lg-3 col-md-12 mb-0 bg-white">
											<input type="text" class="form-control input-lg br-tr-md-0 br-br-md-0" id="text4" placeholder="Find Product">
										</div>
										...
										<div class="form-group col-xl-3 col-lg-3 col-md-12 select2-lg  mb-0 bg-white">
											<select class="form-control select2-show-search border-bottom-0 w-100" data-placeholder="Select">
												<optgroup label="Categories">
													...
													<option value="5">Randolph Barre</option>
						...
						<div class="card overflow-hidden">
							...
							<div class="card-body">
								<div class="item-det mb-4">
									<a href="#" class="text-dark"><h3 class="">CrusaderRecusandae</h3></a>
									<ul class="d-flex">
										<li class="mr-5"><a href="#" class="icons"><i class="icon icon-car text-muted mr-1"></i>Cars</a></li>
								...
								<div class="product-slider">
									<div id="carousel" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											...
											<div class="carousel-item"> <img src="../assets/images/media/gallery/v7.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../assets/images/media/gallery/v8.jpg" alt="img"> </div>
											<div class="carousel-item"> <img src="../assets/images/media/gallery/v9.jpg" alt="img"> </div>
											</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="product-tags clearfix">
									<ul class="list-unstyled mb-0">
										<li><a href="#">Herkime</a></li>
										<li><a href="#">Brattleboro</a></li>
										<li><a href="#">Shrinking  Moco</a></li>
										<li><a href="#">Randolph Barre</a></li>
									...
									<ul class="vertical-scroll">
										<li class="item">
											<div class="media m-0 mt-0 p-5">
												...
												<div class="media-body">
													<h4 class="mt-2 mb-1">Bennington</h4>
										...
										<li class="item">
											<div class="media p-5 mt-0">
												...
												<div class="media-body">
													<h4 class="mt-2 mb-1">ShelburneCars</h4>
													<span class="rated-products-ratings">
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
										...
										<li class="item">
											<div class="media p-5 mt-0">
												...
												<div class="media-body">
													<h4 class="mt-2 mb-1">SlingaCars</h4>
													<span class="rated-products-ratings">
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
										...
										<li class="item">
											<div class="media  mb-0 p-5 mt-0">
												...
												<div class="media-body">
													<h4 class="mt-2 mb-1">BrattleboroCars</h4>
													<span class="rated-products-ratings">
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
														<i class="fa fa-star text-warning"> </i>
